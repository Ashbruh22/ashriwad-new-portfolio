...
// React Bits — DecryptedText. Vendored from
// https://reactbits.dev/r/DecryptedText-TS-TW ; adapted to drop the `motion`
// dependency (the component used `motion.span` only as a styled element, no
// motion features) and to honour the site's reduced-motion toggle.
...
export default function DecryptedText({
  ...
  }, [animateOn, hasAnimated, triggerDecrypt, isReducedMotion]);
  ...
  const animateProps =
    !isReducedMotion && (animateOn === 'hover' || animateOn === 'inViewHover')
      ? {
          onMouseEnter: triggerHoverDecrypt,
          onMouseLeave: resetToPlainText
        }
      : !isReducedMotion && animateOn === 'click'
        ? { onClick: handleClick }
        : {};
